...
export type MergeQueueOperation = 'status' | 'drive' | 'arbiter-status' | 'arbiter-run' | 'plan' | 'next' | 'resolve' | 'review' | 'reopen' | 'supersede-lifecycle-journal' | 'reconcile' | 'refresh' | 'withdraw';
